// FIRST CVSS v4.0 calculator, BSD-2-Clause. See LICENSE and SOURCE.md.
...
function cvss_score(cvssSelected, lookup, maxSeverityData, macroVectorResult) {
    // Scoped locals for ES modules; upstream arithmetic is unchanged.
    let AV_levels, PR_levels, UI_levels, AC_levels, AT_levels, VC_levels, VI_levels, VA_levels, SC_levels, SI_levels, SA_levels, CR_levels, IR_levels, AR_levels, E_levels, value, eq1, eq2, eq3, eq4, eq5, eq6, eq1_next_lower_macro, eq2_next_lower_macro, eq3eq6_next_lower_macro, eq3eq6_next_lower_macro_left, eq3eq6_next_lower_macro_right, eq4_next_lower_macro, eq5_next_lower_macro, score_eq1_next_lower_macro, score_eq2_next_lower_macro, score_eq3eq6_next_lower_macro_left, score_eq3eq6_next_lower_macro_right, score_eq3eq6_next_lower_macro, score_eq4_next_lower_macro, score_eq5_next_lower_macro, eq1_maxes, eq2_maxes, eq3_eq6_maxes, eq4_maxes, eq5_maxes, max_vectors, max_vector, severity_distance_AV, severity_distance_PR, severity_distance_UI, severity_distance_AC, severity_distance_AT, severity_distance_VC, severity_distance_VI, severity_distance_VA, severity_distance_SC, severity_distance_SI, severity_distance_SA, severity_distance_CR, severity_distance_IR, severity_distance_AR, current_severity_distance_eq1, current_severity_distance_eq2, current_severity_distance_eq3eq6, current_severity_distance_eq4, current_severity_distance_eq5, step, available_distance_eq1, available_distance_eq2, available_distance_eq3eq6, available_distance_eq4, available_distance_eq5, percent_to_next_eq1_severity, percent_to_next_eq2_severity, percent_to_next_eq3eq6_severity, percent_to_next_eq4_severity, percent_to_next_eq5_severity, n_existing_lower, normalized_severity_eq1, normalized_severity_eq2, normalized_severity_eq3eq6, normalized_severity_eq4, normalized_severity_eq5, maxSeverity_eq1, maxSeverity_eq2, maxSeverity_eq3eq6, maxSeverity_eq4, mean_distance, eq1_max, eq2_max, eq3_eq6_max, eq4_max, eq5max;
...
function m(cvssSelected, metric) {
    // Scoped locals for ES modules; upstream arithmetic is unchanged.
    let selected, modified_selected;
...
export {cvss_score,macroVector,cvssLookup_global,maxSeverity,expectedMetricOrder};
